...
toMatchInlineSnapshot is very cool, if used for short and focus snapshots. Great for asserting on error messages.
Idea: Use msw to mock AWS S3 to reduce test flakiness?
