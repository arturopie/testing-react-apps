...
## Notes
* What do you think about the use of faker?
** Have you seen faker in npm and github. It's very sus
** I think his reasoning (the test saying if the username value is important), can be easily achieved by the test name. In fact, it's a good practice to been able to rewrite the test body just by reading the test name
** The downside of fake is that it introduces flakiness to the test
* test-data-bot is like FactoryBot in Ruby
  * I don't see much value on this library, other than maybe sequence and traits
